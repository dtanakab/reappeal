...
RSpec.describe "SlideShow", type: :system do
  ...
  describe "show" do
    context "with sign_in and any slides" do
      before do
        sign_in(@visible_slide_show)
        visit "/slide_shows/#{@visible_slide_show.id}"
      end
    ...
    context "with sign_in and no slides" do
      before do
        @not_yet_slide_show = create(:slide_show2)
        sign_in(@not_yet_slide_show)
        visit "/slide_shows/#{@not_yet_slide_show.id}"
      end
  ...
  describe "edit" do
    ...
    context "with sign_in and has visible_slides" do
      it "return slide_show page" do
        sign_in(@visible_slide_show)
        visit "/slide_shows/#{@visible_slide_show.id}/edit"
  ...
  describe "update" do
    context "with sign_up" do
      it "create slideshow" do
        @not_yet_slide_show = create(:slide_show2)
        sign_in(@not_yet_slide_show)
        visit "/slide_shows/#{@not_yet_slide_show.id}/edit"
